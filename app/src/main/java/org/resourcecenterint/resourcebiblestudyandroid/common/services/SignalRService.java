package org.resourcecenterint.resourcebiblestudyandroid.common.services;
...
public class SignalRService extends Service {
    ...
    private void startSignalR() {
        ...
        mHubConnection = new HubConnection(Constants.getSignalRChatUrl());
        ...
        String CLIENT_METHOD_BROADAST_MESSAGE = "sendMessageToAll";
        mHubProxy.on(CLIENT_METHOD_BROADAST_MESSAGE,
                new SubscriptionHandler1<ChatMessage>() {
                    @Override
                    public void run(final ChatMessage msg) {
                        final String finalMsg = msg.getUserName() + " says " + msg.getMessageText();
